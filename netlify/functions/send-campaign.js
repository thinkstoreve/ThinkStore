exports.handler = async function(event) {
  ...
  function htmlFor(name) {
    const banner = bannerUrl ? `<div style="background:#f5f5f7;border:1px solid #ececef;border-radius:22px;padding:18px;margin:0 0 28px;text-align:center;"><img src="${esc(bannerUrl)}" alt="iPhone 18 · Preventa ThinkStore" style="display:block;width:100%;max-width:100%;height:auto;border:0;margin:0 auto;border-radius:14px;background:#f5f5f7;"></div>` : '';
    const priceCells = [];
